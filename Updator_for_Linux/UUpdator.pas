...
type
  ...
  TFrmUpdatorForLinux = class(TForm)
    ADS: TDataSource;
    BtnUpdate: TPanel;
    AQu: TSQLQuery;
    pnlUpdate: TPanel;
...
var
  FrmUpdatorForLinux: TFrmUpdatorForLinux;
...
function TFrmUpdatorForLinux.ExecuteSQL(SS: String): Boolean;
begin
  try
...
procedure TFrmUpdatorForLinux.BtnUpdateClick(Sender: TObject);
begin
...
procedure TFrmUpdatorForLinux.BtnUpdateMouseEnter(Sender: TObject);
begin
  BtnUpdate.Color := clSkyBlue;
end;

procedure TFrmUpdatorForLinux.BtnUpdateMouseLeave(Sender: TObject);
begin
